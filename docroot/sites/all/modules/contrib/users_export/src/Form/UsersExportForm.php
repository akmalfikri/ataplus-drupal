...
/**
 * @file
 * Contains \Drupal\users_export\Form\UsersExportForm.
 */
...
class UsersExportForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    foreach ($exporters as $exporter) {
      $jsSettings[$exporter['id']] = array_intersect_key($exporter, array_flip(array('extension')));
    }
    ...
    $form['advanced']['users_export_with_access'] = [
      '#type'          => 'select',
    ...
    $form['advanced']['users_export_user_status'] = [
      '#type'          => 'select',
    ...
    $form['advanced']['users_export_filter_by_role'] = [
      '#type'          => 'radios',
    ...
    $form['advanced']['users_export_user_role'] = [
      '#type' => 'checkboxes',
      ...
      '#states' => array(
        'invisible' => array(
          ':input[name="users_export_filter_by_role"]' => array('value' => 0),
        ),
      ),
    ];

    $form['advanced']['users_export_order'] = array(
      '#type' => 'select',
  ...
  public function _submitForm(array &$form, FormStateInterface $form_state) {
    ...
    \Drupal::service('users_export.core')->exporterLoadUsers($exporter, array(
