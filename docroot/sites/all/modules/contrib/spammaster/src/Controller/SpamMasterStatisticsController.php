...
class SpamMasterStatisticsController extends ControllerBase {
  ...
  public function spamMasterStatistics() {
    ...
    $spammaster_spam_system_logs_query1->where('(spamkey != :firewall AND spamkey != :registration AND spamkey != :comment AND spamkey != :contact AND spamkey != :honeypot AND spamkey != :recaptcha)', [
    ...
    $spammaster_spam_system_logs_query2->where('(spamkey != :firewall AND spamkey != :registration AND spamkey != :comment AND spamkey != :contact AND spamkey != :honeypot AND spamkey != :recaptcha)', [
      ':firewall' => 'spammaster-firewall',
      ':registration' => 'spammaster-registration',
      ':comment' => 'spammaster-comment',
      ':contact' => 'spammaster-contact',
    ...
    $spammaster_spam_system_logs_query3->where('(spamkey != :firewall AND spamkey != :registration AND spamkey != :comment AND spamkey != :contact AND spamkey != :honeypot AND spamkey != :recaptcha)', [
      ':firewall' => 'spammaster-firewall',
      ':registration' => 'spammaster-registration',
      ':comment' => 'spammaster-comment',
      ':contact' => 'spammaster-contact',
    ...
    $spammaster_spam_system_logs_query4->where('(spamkey != :firewall AND spamkey != :registration AND spamkey != :comment AND spamkey != :contact AND spamkey != :honeypot AND spamkey != :recaptcha)', [
      ':firewall' => 'spammaster-firewall',
      ':registration' => 'spammaster-registration',
      ':comment' => 'spammaster-comment',
      ':contact' => 'spammaster-contact',
    ...
    $spammaster_spam_system_logs_query5->where('(spamkey != :firewall AND spamkey != :registration AND spamkey != :comment AND spamkey != :contact AND spamkey != :honeypot AND spamkey != :recaptcha)', [
      ':firewall' => 'spammaster-firewall',
      ':registration' => 'spammaster-registration',
      ':comment' => 'spammaster-comment',
      ':contact' => 'spammaster-contact',
    ...
    $spammaster_spam_registration_query1 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_registration_query2 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_registration_query3 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_registration_query4 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_registration_query5 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_comment_query1 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_comment_query2 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_comment_query3 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_comment_query4 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_comment_query5 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_contact_query1 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_contact_query2 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_contact_query3 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_contact_query4 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_contact_query5 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_recaptcha_query1 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_recaptcha_query2 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_recaptcha_query3 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_recaptcha_query4 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_recaptcha_query5 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_total_system_logs->where('(spamkey != :firewall AND spamkey != :registration AND spamkey != :comment AND spamkey != :contact AND spamkey != :honeypot AND spamkey != :recaptcha)', [
      ':firewall' => 'spammaster-firewall',
      ':registration' => 'spammaster-registration',
      ':comment' => 'spammaster-comment',
      ':contact' => 'spammaster-contact',
    ...
    $spammaster_total_registration = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_total_comment = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_total_contact = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_total_recaptcha = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_system_logs_month1->where('(spamkey != :firewall AND spamkey != :registration AND spamkey != :comment AND spamkey != :contact AND spamkey != :honeypot AND spamkey != :recaptcha)', [
      ':firewall' => 'spammaster-firewall',
      ':registration' => 'spammaster-registration',
      ':comment' => 'spammaster-comment',
      ':contact' => 'spammaster-contact',
    ...
    $spammaster_spam_system_logs_month2->where('(spamkey != :firewall AND spamkey != :registration AND spamkey != :comment AND spamkey != :contact AND spamkey != :honeypot AND spamkey != :recaptcha)', [
      ':firewall' => 'spammaster-firewall',
      ':registration' => 'spammaster-registration',
      ':comment' => 'spammaster-comment',
      ':contact' => 'spammaster-contact',
    ...
    $spammaster_spam_system_logs_month3->where('(spamkey != :firewall AND spamkey != :registration AND spamkey != :comment AND spamkey != :contact AND spamkey != :honeypot AND spamkey != :recaptcha)', [
      ':firewall' => 'spammaster-firewall',
      ':registration' => 'spammaster-registration',
      ':comment' => 'spammaster-comment',
      ':contact' => 'spammaster-contact',
    ...
    $spammaster_spam_registration_month1 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_registration_month2 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_registration_month3 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_comment_month1 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_comment_month2 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_comment_month3 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_contact_month1 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_contact_month2 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_contact_month3 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_recaptcha_month1 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_recaptcha_month2 = $this->connection->select('spammaster_keys', 'u');
    ...
    $spammaster_spam_recaptcha_month3 = $this->connection->select('spammaster_keys', 'u');
